...
import { Play, ExternalLink, Zap, Copy, Check, Layers, Server, GitBranch } from "lucide-react"
...
const endpoints: ApiEndpoint[] = [
  {
    ...
    method: "GET",
    path: "/api/",
    description: "Welcome page listing all available routes",
  },
  {
    name: "Health Check",
    method: "GET",
  ...
  },
  {
    ...
    method: "GET",
    path: "/api/api/todos",
    description: "GET route returning all todos with total count",
  },
  {
    name: "Create Todo",
    method: "POST",
    path: "/api/api/todos",
    description: "POST route with JSON body to create a new todo",
    body: { title: "Learn Chi Router" },
  },
  {
    name: "Get Todo by ID",
    method: "GET",
    path: "/api/api/todos/1",
    description: "Dynamic route parameter with chi.URLParam(r, \"id\")",
  },
  {
    name: "Toggle Todo",
    method: "PATCH",
    path: "/api/api/todos/1/toggle",
    description: "Toggle todo completion status",
  },
  {
    name: "Delete Todo",
    method: "DELETE",
    path: "/api/api/todos/3",
      ...
      <header className="header-border relative z-10">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-end">
            <a
              href="https://github.com/TencentEdgeOne/go-chi-template"
              target="_blank"
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="text-center space-y-6 animate-fade-in-up">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Build composable web applications with <code className="text-[#00ADD8] bg-[#00ADD8]/10 px-1.5 py-0.5 rounded">Chi</code> router.
              Features composable middleware, subrouters, URL parameters, and idiomatic Go patterns.
            </p>
          </div>

          {/* Action Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up animation-delay-100">
            <a href="https://edgeone.ai/pages/new?from=github&template=go-chi-template" target="_blank" rel="noopener noreferrer">
          ...
          <div className="code-block text-left animate-fade-in-up animation-delay-200">
            <div className="code-block-header">
              ...
              <button 
                onClick={handleCopy}
                className="p-1.5 rounded-md hover:bg-[#00ADD8]/10 transition-colors cursor-pointer"
                aria-label="Copy code"
              >
                {copied ? (
                  <Check className="w-4 h-4 text-[#00ADD8]" />
                ) : (
          ...
          <div className="space-y-4 animate-fade-in-up animation-delay-300">
            <h2 className="text-lg font-semibold text-gray-300 pb-2 border-b border-[#00ADD8]/20">
              API Endpoints
            </h2>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className={`method-badge ${
                          ...
                          : endpoint.method === "PATCH" ? "method-patch"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-12">
            <div className="feature-card p-5 animate-fade-in-up animation-delay-100">
              ...
              <h3 className="font-semibold mb-2">Composable Middleware</h3>
            ...
            <div className="feature-card p-5 animate-fade-in-up animation-delay-200">
              <div className="w-10 h-10 mb-4 rounded-lg bg-[#00ADD8]/15 flex items-center justify-center">
                <GitBranch className="w-5 h-5 text-[#00ADD8]" />
              </div>
            ...
            <div className="feature-card p-5 animate-fade-in-up animation-delay-300">
              <div className="w-10 h-10 mb-4 rounded-lg bg-[#00ADD8]/15 flex items-center justify-center">
                <Server className="w-5 h-5 text-[#00ADD8]" />
              </div>
              <h3 className="font-semibold mb-2">net/http Compatible</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
